...
export const weapons = [
  ...
  export const itemsThatGivePoints = [
  "fruit tree",
  "clean water",
  "glasses that cure color-blindness",
  "anthology of life-changing poems",
  ...
  export const killCauseAndEffect =
  ["landmine",
  "random mine",
  "bow",
  "shoots",
  ...
  export const cornucopia = ["run", "supply", "weapon", "battle"];
